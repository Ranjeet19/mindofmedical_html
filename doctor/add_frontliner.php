    ...
    <div class="container">
        ...
        <div class="second_div">
            ...
            <div class="add_doctor">
                <h2 class="dashboard_name">Add Frontliner</h2>
            </div>

           <div class="add_div">
               <form class="add_form" method="POST" action="save_doctor.php" enctype="multipart/form-data">
                   <li>
                    <label>Frontliner Name :-</label>
                    <input type="text" name="name" placeholder="Enter Frontliner Name"/>
                   </li>
                    ...
                    <li>
                        ...
                        <input type="text" name="address" value="" placeholder="Add address of Frontliner"/>
                       </li>
                       <li>
                        <label>Frontliner Specalist :-</label>
                        <input type="text" name="special" value="" placeholder="Add special of Frontliner"/>
                       </li>
              
                       <li>
                    <label>Frontliner Image :-</label>
                    <input type="file" name="fileToUpload"placeholder="Add images of Frontliner"/>
                   </li>
