    ...
    <div class="container">
        ...
        <div class="first_div">
            <ul class="ul_list" id="myDIV">
                <a href="../../admin/index.html"> <li class="li_list"><i class="fas fa-tachometer-alt"></i> Dashboard</li></a>
        ...
        <div class="second_div">
            ...
            <div class="add_doctor">
               ...
               <a href="add_frontliner.php" ><div class="add_post_btn"><i class="fas fa-plus"></i> Add Doctors</div></a>
            </div>
...
?>
                <div class="dashboard_div divi">
                    <div class="img_edit_delete_div">
                        ...
                        <div id="edit_delete">
                           <a href="edit_frontliner.php?id=<?php echo $row['id'];?>"><li class="delete"><i class="fas fa-pencil-alt"></i> </li></a> 
                           <a href="delete_frontliner.php?id=<?php echo $row['id'];?>"><li class="delete"> <i class="far fa-trash-alt"></i> </li></a>
                        </div>
                    </div>
