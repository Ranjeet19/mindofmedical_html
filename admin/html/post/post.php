    ...
    <div class="container">
        ...
        <div class="first_div">
            <ul class="ul_list" id="myDIV">
                ...
                <a href="diesease.html"> <li class="li_list active"><i class="fas fa-allergies"></i> Diesease</li></a>
                <a href="../medicine/medicine.html"><li class="li_list"><i class="fas fa-pills"></i> Medicine</li></a>
        ...
        <div class="second_div">
            ...
            <div class="add_doctor">
                ...
                <a href="../diesease/add_post.php"><div class="add_post_btn"><i class="fas fa-plus"></i> Add Post</div></a>
            </div>
...
?>
                 ...
                 <div class="dashboard_div divi">
                    <div class="img_edit_delete_div">
                        ...
                        <h2 class="doc_name"><?php echo $row['title'];?></h2>
                        <div id="edit_delete">
                            <a href="edit_post.php?id=<?php echo $row['id'];?>"> <li class="delete"><i class="fas fa-pencil-alt"></i> </li></a>
                            <a href="delete_post.php?id=<?php echo $row['id'];?>"><li class="delete"> <i class="far fa-trash-alt"></i> </li></a>
                        </div>
                    </div>
