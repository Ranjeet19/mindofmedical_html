    ...
    <div class="container">
        ...
        <div class="second_div">
            ...
            <div class="add_doctor">
                <h2 class="dashboard_name">Add Medicines</h2>
            </div>

            <div class="add_div">
               <form class="add_form" method="POST" action="save_medicine.php" enctype="multipart/form-data">
                   <li>
                    <label>name :-</label>
                   ...
                   <li>
                    <label>Diasese :-</label>
                    <input type="text" name= "diasese" placeholder="Enter post title"/>
                   </li>
                   <li>
                    <label>Kefacts :-</label>
                    <input type="text" name= "kefacts" placeholder="Enter post title"/>
                   </li>
                  
                   <li>
                    <label>side effect :-</label>
                    <input type="text" name= "se" placeholder="Enter post title"/>
                   </li>
                   <li>
                    ...
                    <input type="text" name= "etitle" placeholder="Enter post title"/>
                   </li>
                   <li>
                    <label>extra Descreption:-</label>
                    <textarea id="message" name="edesc" placeholder="Enter post Description..." required ></textarea>
                    </li>
